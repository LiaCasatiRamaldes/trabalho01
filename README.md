...
> O sistema prposto conterá as informacões aqui detalhadas. Dos Projetos serão armazenados nome, endereço, localização dos departamentos de policia do país e sons de grito, bater de portas, socos, tapas, coisas quebrando. Será armazenado o nome, endereço e a delegacia mais proxima no momento do cadastro. Para identificar os sons serão armazenados, 100 tipos de gritos femininos diferentes, 100 sons de quebra de objetos, 100 sons de portas batendo de formas diferentes, 100 sons de tapas e 100 sons de socos. É importante destacar que estes sons devem ser analisados em conjunto, sendo acionado a policia . Com relação aos dependentes serão armazenadas as informações de nome do dependente, data de nascimento, sexo e grau de parentesco. Cada empregado pode ter vários dependentes, mas um dependente esta associado apenas a um único empregado. Com relação ao histórico de salário devemos armazenar as informações de valor do salário, data de início do salário no período e data final do salário no período. É importante lembrar que cada funcionario pode ter diversos eventos de histórico de salário associados a ele visto que este dado pode ser alterado várias vezes. 
