...
> O sistema proposto conterá as informações aqui detalhadas. Dos dados pessoais do usuário serão armazenados: nome, cpf, rg, tio sanguíneo, contato e sexo. Dos dados pessoais do parceiro: nome, cpf, rg, tipo de relação com usuário, contato e sexo. De policial é necessário: nome e senha. Do endereço: Estado, cidade, bairro, logradouro e complemento. Da delegacia é necessária: uma ligação com endereço e policial. Da casa: uma ligação entre endereço e os moradores. Da captura: data e hora iniciais e finais, o som armazenado, o tipo do arquivo e o sensor. Do som é necessário armazenar, seu tipo. É importante destacar que cada sensor só pode estar alocado em uma casa. O sensor funciona 24 horas por dia captando e comparando os sons captados om os armazenados. Somente os administradores podem adicionar ou alterar as informações dos usuários ou suas próprias, apenas policiais podem ser administradores do sistema
...
### 6	MODELO LÓGICO<br>
![Alt text](https://github.com/SensorDeViolenciaDomestica/trabalho01/blob/master/imagens/Imagem_modeloLogicoVD.PNG)
