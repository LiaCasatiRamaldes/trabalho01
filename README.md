...
> O sistema proposto conterá as informacões aqui detalhadas. Serão armazenados nome, endereço, localização e contato dos departamentos de policia do país e sons de grito, bater de portas, socos, tapas, coisas quebrando. Será armazenado o nome, endereço e a delegacia mais proxima no momento do cadastro. Para identificar os sons serão armazenados, 100 tipos de gritos de medo femininos diferentes,100 xingamentos em vozes masculinas, 100 sons de quebra de objetos, 100 sons de portas batendo de formas diferentes, 100 sons de tapas e 100 sons de socos. É importante destacar que estes sons devem ser analisados em conjunto, sendo acionado a policia somente quando 3 ou mais desses sons acontecerem no periodo de no maximo 1 hora.
...
#### 4.2 QUAIS PERGUNTAS PODEM SER RESPONDIDAS COM O SISTEMA PROPOSTO?
 ...
    b) Crie uma lista com os 5 principais relatórios que poderão ser obtidos por meio do sistema proposto!
    ...
    - Como funciona o sistema de armazenamento de dados?
    - 
